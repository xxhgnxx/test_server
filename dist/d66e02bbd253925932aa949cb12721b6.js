...
var dom_bottom = '';
var tmp_dom_end = '</div>';
for (var i = 0; i < tyle_list.length; i++) {
  var element_lv1 = tyle_list[i];
  ...
  if (element_lv1.children.length) {
    ...
    for (var k = 0; k < element_lv1.children.length; k++) {
      var element_lv2 = element_lv1.children[k];
...
require('./js.js');
},{"./jquery-3.1.1.min.js":5,"./list.js":6,"./js.js":7}],9:[function(require,module,exports) {
...
//# sourceMappingURL=/dist/d66e02bbd253925932aa949cb12721b6.map